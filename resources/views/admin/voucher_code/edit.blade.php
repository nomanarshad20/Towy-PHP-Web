...
@section('body')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Voucher Code Edit</h4>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="updateForm">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="voucher_code" class="form-control"
                                           placeholder="Enter Voucher Code" value="{{$data->voucher_code}}">
                                </div>
                            </div><!-- Col -->
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="expiry_date" class="form-control datepicker"
                                           placeholder="Enter Expiry Date" value="{{\Carbon\Carbon::parse($data->expiry_date)->format('m/d/Y')}}">
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-6">
                                <div class="mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="discount_value" class="form-control"
                                           placeholder="Enter Discounted Value" value="{{$data->discount_value}}" onkeypress="return isNumberKey(event)">
                                </div>
                            </div><!-- Col -->
                        ...
                        <a href="{{route('voucherCodeListing')}}">
